                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <h2 style="text-align:center; color: #000000; line-height:32px"><?php echo e(__('Qurey, From ').(isset(\Utility::settings()['company_name']) && !empty(\Utility::settings()['company_name']))?\Utility::settings()['company_name']:env('APP_NAME').'!'); ?></h2>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0; text-align: center;"><b><?php echo e(__('Name')); ?> : </b> <?php echo e($user['name']); ?></p>
                                                                <p style="margin: 10px 0; text-align: center;"><b><?php echo e(__('Email')); ?> : </b> <?php echo e($user['email']); ?></p>
                                                                <p style="margin: 10px 0; text-align: center;"><b><?php echo e(__('Contact')); ?> : </b> <?php echo e($user['phone']); ?></p>
                                                                <p style="margin: 10px 0; text-align: center;"><b><?php echo e(__('Query')); ?> : </b> <?php echo e($user['message']); ?></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
<?php /**PATH /var/www/vmycards-2/resources/views/email/query.blade.php ENDPATH**/ ?>