                        ...
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        <h3 id="<?php echo e($stringid . '_title'); ?>_preview" class="text-white"><?php echo e($business->title); ?></h3>
                                        <p id="<?php echo e($stringid . '_designation'); ?>_preview" class="text-white"><?php echo e($business->designation); ?>

                                        </p>
                                        <h6 id="<?php echo e($stringid . '_subtitle'); ?>_preview" class="text-white"><?php echo e($business->sub_title); ?></h6>
                                    </div>
                                </div>
                                <div class="text-center desc-wrapper">
                                    <p id="<?php echo e($stringid . '_desc'); ?>_preview" class="text-white"><?php echo e($business->description); ?></h3>
                                </div>
                            </div>
                        </section>
                        <?php $j = 1; ?>
                                                    ...
                                                    <div class="testimonial-card"
                                                        ...
                                                        <div class="testimonial-card-inner">
                                                            <div class="user-pro">
                                                                ...
                                                                <span class="total-rat"><?php echo e($testi_content->rating); ?>/5</span><br>
                                                                <?php
                                                                    if (!empty($testi_content->rating)) {
                                                                        $rating = (int) $testi_content->rating;
                                                                        $overallrating = $rating;
                    ...
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="app_name" placeholder="<?php echo e(__('Enter your name')); ?>">
                                <span class="text-danger  h6 span-error-name"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Email:')); ?></label>
                                <input type="email" name="email" class="app_email" placeholder="<?php echo e(__('Enter your email')); ?>">
                ...
                <div class="modal-content">
                    ...
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                                <label><?php echo e(__('Name:')); ?></label>
                                <input type="text" name="name" class="contact_name" placeholder="<?php echo e(__('Enter your name')); ?>">
                                <span class="text-danger  h6 span-error-contactname"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Email:')); ?></label>
                                <input type="email" name="email" class="contact_email" placeholder="<?php echo e(__('Enter your email')); ?>">
                                <span class="text-danger  h6 span-error-contactemail"></span>
                            </div>
                            <div class="form-group">
                                <label><?php echo e(__('Phone:')); ?></label>
                                <input type="tel" name="phone" class="contact_phone" placeholder="<?php echo e(__('Enter your phone no')); ?>">
...
<?php
  exit();
?><?php /**PATH /var/www/vmycards-2/resources/views/card/theme2/index.blade.php ENDPATH**/ ?>