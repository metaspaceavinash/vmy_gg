...
.innerabout ul li:nth-child(odd){ margin-left: 25px;}
 ...
 to ensure a lasting impression. </p>
      ...
      <div class="row">
        <div class="col-12 col-lg-6"><img src="<?php echo e(asset('landing/assets/img/vmycardabout.png')); ?>" class="mx-auto d-block img-fluid aboutusimg "></div>
...
<?php
  exit();
?>
<?php /**PATH /var/www/vmycards-2/resources/views/layouts/about.blade.php ENDPATH**/ ?>