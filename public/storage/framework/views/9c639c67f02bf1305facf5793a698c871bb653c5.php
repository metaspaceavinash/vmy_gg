...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme18'][$business->theme_color]['theme_name']); ?>" id="view_theme7">
                                            ...
                                            <?php $__currentLoopData = $testimonials_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k2 => $testi_content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="testimonial-itm" id="testimonials_<?php echo e($testimonials_row_no); ?>">
                                                    <div class="testimonial-itm-inner">
                                                        ...
                                                        <p id="testimonial_description_<?php echo e($testimonials_row_no); ?>_preview">
                                                            <?php echo e($testi_content->description); ?>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control app_name"
                                        placeholder="<?php echo e(__('Enter your name')); ?>" id="recipient-name">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control app_email"
                                        placeholder="<?php echo e(__('Enter your email')); ?>" id="recipient-name">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone" class="form-control app_phone"
                                        placeholder="<?php echo e(__('Enter your phone no.')); ?>" id="recipient-name">
                                    <div class="">
    ...
    <script src="<?php echo e(asset('custom/theme18/modal/bootstrap.min.js')); ?>"></script>
...
<?php
  exit();
?><?php /**PATH /var/www/vmycards-2/resources/views/card/theme18/index.blade.php ENDPATH**/ ?>