        ...
        <div class="m-header main-logo">
            <a href="#" class="b-brand">
                ...
                <?php if($setting['cust_darklayout'] == 'on'): ?>
                    <img  src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png').'?'.time()); ?>" alt=""
                        class="img-fluid" />
                <?php else: ?>
                    <img  src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png').'?'.time()); ?>" alt=""
                        class="img-fluid" />
                <?php endif; ?>
            ...
            <ul class="dash-navbar">
                ...
                <?php if(\Auth::user()->can('manage business')): ?>
                    <?php if(\Auth::user()->can('create business')): ?>
                        ...
                        <?php if($bussiness_id==''|| is_null($bussiness_id)): ?>
                        <li class="dash-item <?php echo e((Request::segment(1) == 'business')?'active':''); ?>">
                            <a href="#" class="dash-link" data-bs-toggle="modal" data-bs-target="#exampleModal" data-url="<?php echo e(route('business.create')); ?>" data-size="xl" data-bs-whatever="<?php echo e(__('Create New Business')); ?>"> <span class="dash-micon"><i class="ti ti-credit-card"></i></span><span class="dash-mtext"><?php echo e(__('Create business')); ?></span>
                            </a>
                        </li>
                        <?php else: ?>
                        <li class="dash-item <?php echo e((Request::segment(1) == 'business')?'active':''); ?>">
                ...
                <li class="dash-item dash-hasmenu">
                    ...
                    <ul class="dash-submenu">
                        <?php if(Auth::user()->type == 'super admin'): ?>
                            <li class="dash-item <?php echo e((Request::segment(1) == 'sadmin_request_cards')?'active2':''); ?>">
                              <a href="<?php echo e(route('physical.sadmin_view_request_order')); ?>" class="dash-link"> <span class="dash-mtext">Order Status</span></a>
                            </li>
                        <?php else: ?>
                        <li class="dash-item <?php echo e((Request::segment(1) == 'physical_card')?'active1':''); ?>">
                            <a href="<?php echo e(route('physical_card.index')); ?>" class="dash-link"><span class="dash-mtext">Request Now</span></a>
                        </li>
                        <li class="dash-item <?php echo e((Request::segment(1) == 'request_cards')?'active2':''); ?>">
                            <a href="<?php echo e(route('physical.view_request_order')); ?>" class="dash-link"> <span class="dash-mtext">Order Status</span></a>
                        </li>
...
<?php /**PATH C:\laragon\www\vmy_gg\vmycard\resources\views/partials/admin/sidemenu.blade.php ENDPATH**/ ?>