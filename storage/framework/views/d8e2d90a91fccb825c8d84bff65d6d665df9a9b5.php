...
<?php echo $__env->make('physical-cards.main_phy',[$SER,$card_id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <?php $jj="";   
       ...
       ?>
                ...
                <?php $__currentLoopData = range(1, $total_phy_card); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($value==1): ?>
                        <?php $jj="checked"; ?>
                    <?php else: ?>
                <?php $jj=""; ?>
