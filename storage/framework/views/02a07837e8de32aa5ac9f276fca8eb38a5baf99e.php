...
<body class="tech-card-body">
                        ...
                        <div class="row appo-form-details">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control app_name" placeholder="<?php echo e(__('Enter your name')); ?>">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control app_email" placeholder="<?php echo e(__('Enter your email')); ?>">
                                    <div class="">
    ...
    <script src="<?php echo e(asset('custom/theme21/modal/bootstrap.min.js')); ?>"></script>
...
<?php
  exit();
?>
<?php /**PATH /var/www/vmycards-2/resources/views/card/theme21/index.blade.php ENDPATH**/ ?>