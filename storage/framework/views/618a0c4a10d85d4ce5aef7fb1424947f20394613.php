...
?>
    ...
    <form name="card_request" id="card_request" action="/card_request" method="post">
        ...
        <div class="d-flex align-items-center justify-content-between mt-3 sclFlex">
         ...
         <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\vmy_gg\vmycard\resources\views/plan/physical.blade.php ENDPATH**/ ?>