                ...
                <div class="col-lg-4 welcome-card">
                    <div class="border bg-light-success p-3 border-success rounded text-dark h-100">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                <h5 class="mb-0">
                                    <span class="d-block" id="greetings"><?php echo e(__('Good Afternoon,')); ?></span>
                    ...
                    <div class="col-md-2">
                        <div class="card">
                            <div class="card-body" style="min-height: 230px;">
                                <h6 class="mb-0"><?php echo e(ucFirst($businessData->title)); ?></h6>
                                ...
                                <a href="#!" class="btn btn-light-primary w-100 cp_link"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy ms-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\vmy_gg\vmycard\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>