...
.flip-card-front {
  ...
  color: black;
  background-image: url("<?php echo e($SER); ?>/assets/card-images/1FrontBlank.png") !important;
  display: flex;
...
.flip-card-back {
  color: white;
  transform: rotateY(180deg);
  background-image: url("<?php echo e($SER); ?>/assets/card-images/1BackBlank.png") !important;
}
