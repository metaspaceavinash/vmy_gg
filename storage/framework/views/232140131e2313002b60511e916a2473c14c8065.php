...
.flip-card-front {
  ...
  color: black;
  background-image: url("<?php echo e($SER); ?>/assets/card-images/3FrontBlank.png") !important;
  display: flex;
...
.flip-card-back {
  color: white;
  transform: rotateY(180deg);
  background-image: url("<?php echo e($SER); ?>/assets/card-images/3BackBlank.png") !important;
}
...
<?php /**PATH C:\laragon\www\vmy_gg\vmycard\resources\views/physical-cards/3/index.blade.php ENDPATH**/ ?>