...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="<?php echo e(\App\Models\Utility::themeOne()['theme20'][$business->theme_color]['theme_name']); ?>" id=view_theme9>
                                                                ...
                                                                <li id="contact_<?php echo e($loop->parent->index + 1); ?>">
                                                                    <div class="justify-content-start">
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <?php endif; ?>
                                                                            <span id="<?php echo e($social_key1 . '_' . $no); ?>_preview">
    ...
    <script src="<?php echo e(asset('custom/theme20/modal/bootstrap.min.js')); ?>"></script>
...
<?php
  exit();
?><?php /**PATH /var/www/vmycards-2/resources/views/card/theme20/index.blade.php ENDPATH**/ ?>