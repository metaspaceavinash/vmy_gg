...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme20'][$business->theme_color]['theme_name'] }}" id=view_theme9>
                                                                        ...
                                                                        @else
                                                                            @if ($social_key1 == 'Whatsapp')
                                                                                ...
                                                                                @else
                                                                                    <a href="{{ $href }}">
                                                                            @endif
                                                                            <span id="{{ $social_key1 . '_' . $no }}_preview">
                                                                                {{ $social_val1 }}</span>
                                                                            </a>
                                                                        @endif
                                                                    </div>
    ...
    <script src="{{ asset('custom/theme20/modal/bootstrap.min.js') }}"></script>
