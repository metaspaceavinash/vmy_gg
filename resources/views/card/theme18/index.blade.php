...
<head>
    ...
    <meta property="og:image" content="{{!empty($business->meta_image)?$meta_tag_image:asset('custom/img/placeholder-image.jpg')}}">
    ...
    <meta property="twitter:image" content="{{!empty($business->meta_image)?$meta_tag_image:asset('custom/img/placeholder-image.jpg')}}">
    {{-- End Meta tag Preview --}}

    <link rel="icon" href="{{ $logo1 . (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png') }}" type="image" sizes="16x16">
    ...
    @endif
     ...
     @if ($business->enable_pwa_business == 'on' && $plan->pwa_business == 'on')
         <link rel="manifest" href="{{asset('storage/uploads/theme_app/business_' .$business->id.'/manifest.json')}}" />
     @endif
     ...
     @if (!empty( $business->pwa_business($business->slug)->background_color))
         <meta name="apple-mobile-web-app-status-bar" content="{{$business->pwa_business($business->slug)->background_color}}" />
     @endif
...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="{{ \App\Models\Utility::themeOne()['theme18'][$business->theme_color]['theme_name'] }}" id="view_theme7">
                ...
                @foreach ($card_theme->order as $order_key => $order_value)
                    @if ($j == $order_value)
                        ...
                        @if ($order_key == 'testimonials')
                            <section class="testimonials-section box-shadow padding-top padding-bottom" id="testimonials-div">
                                <div class="container">
                                    <div class="section-title text-center">
                                    ...
                                    @if (isset($is_pdf))
                                        <div class="row testimonial-pdf-row" id="inputrow_testimonials_preview">
                                            ...
                                            @foreach ($testimonials_content as $k2 => $testi_content)
                                                <div class=" col-md-6 col-12 testimonial-itm-pdf" id="testimonials_{{ $testimonials_row_no }}">
                                    ...
                                    @else
                                        <div class="testimonial-slider" id="inputrow_testimonials_preview">
                                            ...
                                            @endphp
                                            @foreach ($testimonials_content as $k2 => $testi_content)
                                                <div class="testimonial-itm" id="testimonials_{{ $testimonials_row_no }}">
                        ...
                        @if ($order_key == 'bussiness_hour')
                            <section
                                class="business-hour-section box-shadow padding-top padding-bottom" id="business-hours-div">
                                <div class="container">
                                    <div class="section-title text-center">
                                                    ...
                                                    <li>
                                                        <p>{{ __($day) }} :<span class="days_{{ $k }}">
                                                               @if (isset($business_hours->$k) && $business_hours->$k->days == 'on')
                                                                    <span
                                                                        class="days_{{ $k }}_start">{{ !empty($business_hours->$k->start_time) && isset($business_hours->$k->start_time) ? date('h:i A', strtotime($business_hours->$k->start_time)) : '00:00' }}</span> - <span
                                            ...
                                            <div class="row gallery-cards">
                                                @if (!is_null($gallery_contents) && !is_null($gallery))
                                                    @foreach ($gallery_contents as $key=>$gallery_content)  
                                                        <div class="col-md-6 col-12 p-0 gallery-card-pdf" id="gallery_{{ $gallery_row_no }}">
                                                                        ...
                                                                        @if($gallery_content->type == 'video')
                                                                            <a href="javascript:;" id="" tabindex="0" class="videopop">
                                                                                <video height="" controls> 
                                                                                    <source class="videoresource" src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? $gallery_path .'/'. $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}" type="video/mp4"> 
                                                                                </video> 
                                                                            </a>
                                                                    ...
                                                                    @if(isset($gallery_content->type))
                                                                        ...
                                                                        @elseif($gallery_content->type=='custom_video_link')
                                                                                ...
                                                                                <a href="javascript:;"  id="" tabindex="0" class="videopop1">
                                                                                    <video loop autoplay controls="true">
                                                                                        <source class="videoresource1" src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}" type="video/mp4"> 
                                                                                    </video>  
                                                                                </a>
                                                                        ...
                                                                        @elseif($gallery_content->type=='custom_image_link')
                                                                            ...
                                                                            <a href="javascript:;" id="" target="" tabindex="0" class="imagepopup1">
                                                                                <img class="imageresource1" src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? $gallery_content->value : asset('custom/img/logo-placeholder-image-2.png') }}" alt="images" id="upload_image">
                                                                            </a>
                                                                        @endif
                                                                    @endif
                                                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control app_name"
                                        placeholder="{{ __('Enter your name') }}" id="recipient-name">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control app_email"
                                        placeholder="{{ __('Enter your email') }}" id="recipient-name">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone" class="form-control app_phone"
                                        placeholder="{{ __('Enter your phone no.') }}" id="recipient-name">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" placeholder="Enter your email"
                                        class="form-control con_email" id="recipient-name">
                                    <div class="">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" placeholder="Enter your phone no."
                                        class="form-control con_phone" id="recipient-name">
    ...
    <script src="{{ asset('custom/theme18/modal/bootstrap.min.js') }}"></script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        else
                        {
                            ...
                            show_toastr('Success', "{{ __('Thank you for booking an appointment.') }}", 'success');
                        }
                    }
                });
            }
            ...
            if (name == "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        show_toastr('Success', "{{ __('Your contact details has been noted.') }}", 'success');
                    }
                });
            }
        });
