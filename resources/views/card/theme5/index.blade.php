...
<body class="tech-card-body">
    <div class="{{ \App\Models\Utility::themeOne()['theme5'][$business->theme_color]['theme_name'] }}"
        ...
        <main id="boxes">
                        ...
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    <div class="user-name">
                                        <h2 class="text-white" id="{{ $stringid . '_title' }}_preview">{{ $business->title }}</h2>
                                ...
                                <div class="text-left desc-wrapper">
                                    <p class="text-white" id="{{ $stringid . '_desc' }}_preview">{{ $business->description }}
                                    </p>
                                </div>
                            </div>
                        </section>
                            ...
                            @if ($j == $order_value)
                                                ...
                                                <div class="col-sm-6 col-12 service-card"
                                                    ...
                                                    <div class="service-card-inner">
                                                        ...
                                                        @if (!empty($content->purchase_link))
                                                            <a href="{{ url($content->purchase_link) }}" class="btn"
                                        ...
                                        <div id="inputrow_gallery_preview">
                                            ...
                                            @else
                                                <div class="gallery-slider">
                                                    @if (!is_null($gallery_contents) && !is_null($gallery))
                                                        @foreach ($gallery_contents as $key => $gallery_content)
                                                            <div class="gallery-itm" id="gallery_{{ $gallery_row_no }}">
                                                                <div class="gallery-media">
                                                                    @if (isset($gallery_content->type))
                                                                        @if ($gallery_content->type == 'video')
                                ...
                                @if ($order_key == 'appointment')
                                    <section class="make-appointment" id="appointment-div">
                                        <div class="section-title text-center">
                                            <h2 class="text-white">{{ __('Make') }} <br> {{ __('an appointment') }}</h2>
                                        </div>
                                ...
                                @if ($order_key == 'custom_html')
                                    <section class="card-footer custom_html_text">
                                        <div class="greetings-desk">
                                            <div class="user-text-avatar text-white" id="{{ $stringid . '_chtml' }}_preview">
            ...
            <img src="{{ isset($qr_detail->image) ? $qr_path.'/'. $qr_detail->image : '' }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>{{__('Point your camera at the QR code,')}} <br> <span class="qr-link text-wrap"></span></p>
                ...
                <div class="modal-content">
                    ...
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                                <label>{{__('Name:')}}</label>
                                <input type="text" name="name" class="app_name" placeholder="{{__('')}}Enter your name">
                                <span class="  text-white h6 span-error-name"></span>
                            </div>
                            <div class="form-group">
                                <label>{{__('Email:')}}</label>
                                <input type="email" name="email" class="app_email" placeholder="{{__('')}}Enter your email">
                                <span class="  text-white h6 span-error-email"></span>
                            </div>
                            <div class="form-group">
                                <label>{{__('Phone:')}}</label>
                                <input type="tel" name="phone" class="app_phone" placeholder="{{__('Enter your phone no')}}">
                                <span class=" text-white  h6 span-error-phone"></span>
                            </div>

                        </div>
                        <div class="modal-footer">
                            <button class="btn-secondary appointment-modal-toggle" type="button">{{__('Close')}}</button>
                            <button class="btn-secondary" id="makeappointment" type="button">{{__('Make Appointment')}}</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="">
                        <div class="modal-body">
                            <div class="form-group">
                                <label>{{__('Name:')}}</label>
                                <input type="text" name="name" class="contact_name" placeholder="{{__('Enter your name')}}">
                                <span class=" text-white h6 span-error-contactname"></span>
                            </div>
                            <div class="form-group">
                                <label>{{__('Email:')}}</label>
                                <input type="email" name="email" class="contact_email" placeholder="{{__('Enter your email')}}">
                                <span class=" text-white h6 span-error-contactemail"></span>
                            </div>
                            <div class="form-group">
                                <label>{{__('Phone:')}}</label>
                                <input type="tel" name="phone" class="contact_phone" placeholder="{{__('Enter your phone no')}}">
                        ...
                        <div class="modal-footer">
                            <button class="btn-secondary make-contact-modal-toggle" type="button">{{__('Close')}}</button>
                            <button class="btn-secondary" id="makecontact" type="button">{{__('Make Contact')}}</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="">
                        ...
                        <div class="modal-footer">
                            <button class="btn-secondary password-submit" type="button">{{ __('Submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
