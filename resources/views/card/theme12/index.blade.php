                    ...
                    @if ($j == $order_value)
                        ...
                        @if ($order_key == 'bussiness_hour')
                            <section class="business-hour-section padding-top padding-bottom" id="business-hours-div">
                                <div class="title-svg">
                                    <img src="{{ asset('custom/theme12/icon/' . $color . '/clock.svg') }}" alt="clock"
                                        class="img-fluid">
                                </div>
                                <div class="container">
                                                ...
                                                @foreach ($appoinment_hours as $k => $hour)
                                                    <div class="radio {{ $radiocount % 2 == 0 ? 'radio-left' : '' }}"
                                                        ...
                                                        <input id="radio-{{ $radiocount }}" name="time"
                                                            ...
                                                            class="app_time">
                                                        <label for="radio-{{ $radiocount }}" class="radio-label"><span
                        ...
                        @if ($order_key == 'service')
                            <section class="service-section padding-top padding-bottom" id="services-div">
                                <div class="title-svg">
                                    <img src="{{ asset('custom/theme12/icon/' . $color . '/phone.svg') }}" alt="phone"
                                        class="img-fluid">
                                </div>
                                <div class="container">
                                    <div class="section-title text-center">
                        ...
                        @if ($order_key == 'gallery')
                            <section class="gallery-section padding-top padding-bottom" id="gallery-div">
                                <div class="title-svg">
                                    <img src="{{ asset('custom/theme12/icon/' . $color . '/gallery.svg') }}" alt="phone"
                                        class="img-fluid">
                                </div>
                                <div class="container">
                                    <div class="section-title text-center">
                        ...
                        @if ($order_key == 'social')
                            <section class="social-icons-section padding-top" id="social-div">
                                <div class="title-svg">
                                    <img src="{{ asset('custom/theme12/icon/' . $color . '/share.svg') }}" alt="user"
                                        class="img-fluid">
                                </div>
                                <div class="container">
                                    <div class="section-title text-center">
                    ...
                    <form class="appointment-form-wrapper">
                        <div class="section-title">
                            ...
                            <div class="close-search">
                                <img src="{{ asset('custom/theme12/icon/' . $color . '/close.svg') }}" alt="back"
                                    class="img-fluid">
                            </div>
                        </div>
                        <div class="row appo-form-details">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone" placeholder="{{ __('Enter your phone no') }}"
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <ul class="card-social-icons">
                                ...
                                <li><a href="https://instagram.com"><img
                                            src="{{ asset('custom/theme12/icon/' . $color . '/instagram.svg') }}"
