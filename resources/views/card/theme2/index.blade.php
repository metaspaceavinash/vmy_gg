                        ...
                        <section class="profile-section">
                            ...
                            <div class="profile-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-name">
                                        <h3 id="{{ $stringid . '_title' }}_preview" class="text-white">{{ $business->title }}</h3>
                                        <p id="{{ $stringid . '_designation' }}_preview" class="text-white">{{ $business->designation }}
                                        </p>
                                        <h6 id="{{ $stringid . '_subtitle' }}_preview" class="text-white">{{ $business->sub_title }}</h6>
                                    </div>
                                </div>
                                <div class="text-center desc-wrapper">
                                    <p id="{{ $stringid . '_desc' }}_preview" class="text-white">{{ $business->description }}</h3>
                                </div>
                            </div>
                        </section>
                        @php $j = 1; @endphp
                                                    ...
                                                    <div class="testimonial-card"
                                                        ...
                                                        <div class="testimonial-card-inner">
                                                            <div class="user-pro">
                                                                ...
                                                                <span class="total-rat">{{ $testi_content->rating }}/5</span><br>
                                                                @php
                                                                    if (!empty($testi_content->rating)) {
                                                                        $rating = (int) $testi_content->rating;
                                                                        $overallrating = $rating;
