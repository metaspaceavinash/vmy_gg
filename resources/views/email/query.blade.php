                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <h2 style="text-align:center; color: #000000; line-height:32px">{{__('Qurey, From ').(isset(\Utility::settings()['company_name']) && !empty(\Utility::settings()['company_name']))?\Utility::settings()['company_name']:env('APP_NAME').'!'}}</h2>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0; text-align: center;"><b>{{__('Name')}} : </b> {{$user['name']}}</p>
                                                                <p style="margin: 10px 0; text-align: center;"><b>{{__('Email')}} : </b> {{$user['email']}}</p>
                                                                <p style="margin: 10px 0; text-align: center;"><b>{{__('Contact')}} : </b> {{$user['phone']}}</p>
                                                                <p style="margin: 10px 0; text-align: center;"><b>{{__('Query')}} : </b> {{$user['message']}}</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
