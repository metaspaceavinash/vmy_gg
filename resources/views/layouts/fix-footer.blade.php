...
<div class="topfooter">
  <div class="container">
    <div class="row">
      ...
      <a href="{{ url('/') }}"><img src="{{ asset('landing/assets/img/logo.png') }}" class="img-fluid"></a>
    ...
    <div class="container">
      <div class="row ">
        <div class="col-12 col-lg-12">
          <p class="copyy text-center"><a href="">Copyright © &nbsp;{{ isset($langSetting['footer_text']) ? $langSetting['footer_text'] : 'Metaspace' }} {{ date('Y') }}</a></p>
