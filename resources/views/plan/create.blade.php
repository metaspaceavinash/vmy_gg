...
@endif
 <div class="row">
     ...
     <div class="form-group col-md-6">
         ...
         {{ Form::number('max_users', null, ['class' => 'form-control', 'placeholder' => __('Enter Max User Create Limite')]) }}
         <span class="small">{{ __('Note: "-1" for Unlimited') }}</span>
     </div>
     <div class="form-group col-md-6">
         {{ Form::label('business', __('Max Business'), ['class' => 'form-label']) }}
         {{ Form::number('business', null, ['class' => 'form-control', 'placeholder' => __('Enter Max Business Create Limite')]) }}
         <span class="small">{{ __('Note: "-1" for Unlimited') }}</span>
     </div>
     <div class="form-group col-md-6">
